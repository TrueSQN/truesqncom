	...
	return array('a'=>array(                'title'      => __('Main Settings',$this->parameter['name_option']),        //title section
							...
							'd'=>array(     'title'      => __('Google+ user for days',$this->parameter['name_option']),  
											...
											'options'    => array(
																	...
																	array(  'title' =>__('ID channel',$this->parameter['name_option']),
																			'help'  =>__('Enter the ID of the channel (example: youtube.com/channel/<strong>UCGyaWt2i_UN8qlsBoSbQEBA</strong>',$this->parameter['name_option']),
																			'type'  =>'text',
																			'value' =>'',
																			'id'    =>$this->parameter['name_option'].'_button_youtube_suscribe',
																			'name'  =>$this->parameter['name_option'].'_button_youtube_suscribe',
																			'class' =>'',
																			'placeholder' =>'UCGyaWt2i_UN8qlsBoSbQEBA',
																			'row'   =>array('a','b')),
