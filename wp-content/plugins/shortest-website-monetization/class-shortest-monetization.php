...
class Shortest_Monetization
{
    ...
    public static function get_default_options()
    {
        ...
        $defaults = array(
            'shst_email' => $current_user->user_email,
            'shst_token' => '',
    ...
    public static function get_api_token()
    {
        ...
        $emailChanged = get_option('shst_email_changed');
        $apiReady = get_option('shst_api_ready');
        if ($apiReady && $emailChanged && $email) {
            $request = new WP_Http;
            $result = $request->request(sprintf("https://api.shorte.st/users/%s/token", $email));
